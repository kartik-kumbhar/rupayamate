...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            // const response = await fetch(`https://rupayamatebackend.vercel.app/api/users/register`, {
            //     method: "POST",
            //     headers: {
            ...
            const response = await axios.post(`https://rupayamatebackend.vercel.app/api/users/register`, user);
